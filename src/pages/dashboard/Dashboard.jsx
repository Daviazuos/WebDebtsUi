...
export default function Dashboard() {
  ...
  useEffect(() => {
    let mounted = true;
    axiosInstance.get(Endpoints.debt.filterInstallments(1, 9999, '', month, '2022', '', 'NotPaid', ''))
      .then(res => {
  ...
  useEffect(() => {
    let mounted = true;
    axiosInstance.get(Endpoints.debt.filterInstallments(1, 9999, '', month, '2022', 'Fixed', 'NotPaid', ''))
      .then(res => {
  ...
  useEffect(() => {
    let mounted = true;
    axiosInstance.get(Endpoints.debt.filterInstallments(1, 9999, '', month, '2022', 'Simple', 'NotPaid', ''))
      .then(res => {
  ...
  useEffect(() => {
    let mounted = true;
    axiosInstance.get(Endpoints.debt.filterInstallments(1, 9999, '', month, '2022', 'Installment', 'NotPaid', ''))
      .then(res => {
